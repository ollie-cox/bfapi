		...
		case "competitionIds":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.CompetitionIds = append(out.CompetitionIds, v41)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi24(out *jwriter.Writer, in MarketListFilter) {
	...
	if len(in.MarketIds) != 0 {
		...
		{
			out.RawByte('[')
			for v42, v43 := range in.MarketIds {
				if v42 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.EventTypes) != 0 {
		...
		{
			out.RawByte('[')
			for v44, v45 := range in.EventTypes {
				if v44 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Countries) != 0 {
		...
		{
			out.RawByte('[')
			for v46, v47 := range in.Countries {
				if v46 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.TypeCodes) != 0 {
		...
		{
			out.RawByte('[')
			for v48, v49 := range in.TypeCodes {
				if v48 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.CompetitionIds) != 0 {
		...
		{
			out.RawByte('[')
			for v50, v51 := range in.CompetitionIds {
				if v50 > 0 {
					out.RawByte(',')
				}
		...
		case "runners":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Runners = append(out.Runners, v55)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "marketProjection":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MarketProjection = append(out.MarketProjection, v58)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi29(out *jwriter.Writer, in ListMarketCatalogueArg) {
	...
	if len(in.MarketProjection) != 0 {
		...
		{
			out.RawByte('[')
			for v59, v60 := range in.MarketProjection {
				if v59 > 0 {
					out.RawByte(',')
				}
		...
		case "marketIds":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MarketIds = append(out.MarketIds, v61)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "customerStrategyRefs":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.CustomerStrategyRefs = append(out.CustomerStrategyRefs, v62)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "betIds":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.BetIds = append(out.BetIds, v63)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi30(out *jwriter.Writer, in ListMarketBookArg) {
	...
	if len(in.MarketIds) != 0 {
		...
		{
			out.RawByte('[')
			for v64, v65 := range in.MarketIds {
				if v64 > 0 {
					out.RawByte(',')
				}
...
func easyjson8e2f8dd8DecodeGithubComTarbBfapi31(in *jlexer.Lexer, out *ListCurrentOrdersArgs) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "betIds":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.BetIDs = append(out.BetIDs, v70)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "marketIds":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MarketIDs = append(out.MarketIDs, v71)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi31(out *jwriter.Writer, in ListCurrentOrdersArgs) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.BetIDs) != 0 {
	...
	if len(in.MarketIDs) != 0 {
		...
		{
			out.RawByte('[')
			for v76, v77 := range in.MarketIDs {
				if v76 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.CustomerOrderRefs) != 0 {
		...
		{
			out.RawByte('[')
			for v78, v79 := range in.CustomerOrderRefs {
				if v78 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.CustomerStrategyRefs) != 0 {
		...
		{
			out.RawByte('[')
			for v80, v81 := range in.CustomerStrategyRefs {
				if v80 > 0 {
					out.RawByte(',')
				}
...
func easyjson8e2f8dd8DecodeGithubComTarbBfapi32(in *jlexer.Lexer, out *ListClearedOrdersArgs) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "eventTypeIds":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.EventTypeIDs = append(out.EventTypeIDs, v82)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "eventIds":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.EventIDs = append(out.EventIDs, v83)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "marketIds":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MarketIDs = append(out.MarketIDs, v84)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "runnerIds":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v85 int64
					v85 = int64(in.Int64())
					out.RunnerIDs = append(out.RunnerIDs, v85)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "betIds":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.BetIDs = append(out.BetIDs, v86)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi32(out *jwriter.Writer, in ListClearedOrdersArgs) {
	out.RawByte('{')
	first := true
	_ = first
	if in.BetStatus != "" {
	...
	if len(in.EventTypeIDs) != 0 {
		...
		{
			out.RawByte('[')
			for v89, v90 := range in.EventTypeIDs {
				if v89 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.MarketIDs) != 0 {
		...
		{
			out.RawByte('[')
			for v93, v94 := range in.MarketIDs {
				if v93 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.RunnerIDs) != 0 {
		...
		{
			out.RawByte('[')
			for v95, v96 := range in.RunnerIDs {
				if v95 > 0 {
					out.RawByte(',')
				}
				out.Int64(int64(v96))
	...
	if len(in.CustomerOrderRefs) != 0 {
		...
		{
			out.RawByte('[')
			for v99, v100 := range in.CustomerOrderRefs {
				if v99 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.CustomerStrategyRefs) != 0 {
		...
		{
			out.RawByte('[')
			for v101, v102 := range in.CustomerStrategyRefs {
				if v101 > 0 {
					out.RawByte(',')
				}
...
func easyjson8e2f8dd8DecodeGithubComTarbBfapi33(in *jlexer.Lexer, out *LimitOrder) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi33(out *jwriter.Writer, in LimitOrder) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Size != 0 {
...
func easyjson8e2f8dd8DecodeGithubComTarbBfapi34(in *jlexer.Lexer, out *LimitOnCloseOrder) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi34(out *jwriter.Writer, in LimitOnCloseOrder) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Liability != 0 {
...
func easyjson8e2f8dd8DecodeGithubComTarbBfapi35(in *jlexer.Lexer, out *ItemDescription) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi35(out *jwriter.Writer, in ItemDescription) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson8e2f8dd8DecodeGithubComTarbBfapi36(in *jlexer.Lexer, out *ExchangePrices) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "availableToBack":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AvailableToBack = append(out.AvailableToBack, v103)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "availableToLay":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AvailableToLay = append(out.AvailableToLay, v104)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "tradedVolume":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.TradedVolume = append(out.TradedVolume, v105)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi36(out *jwriter.Writer, in ExchangePrices) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.AvailableToBack) != 0 {
		...
		{
			out.RawByte('[')
			for v106, v107 := range in.AvailableToBack {
				if v106 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.AvailableToLay) != 0 {
		...
		{
			out.RawByte('[')
			for v108, v109 := range in.AvailableToLay {
				if v108 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.TradedVolume) != 0 {
		...
		{
			out.RawByte('[')
			for v110, v111 := range in.TradedVolume {
				if v110 > 0 {
					out.RawByte(',')
				}
...
func easyjson8e2f8dd8DecodeGithubComTarbBfapi37(in *jlexer.Lexer, out *ExchangePrice) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "availableToBack":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AvailableToBack = append(out.AvailableToBack, v112)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "availableToLay":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AvailableToLay = append(out.AvailableToLay, v113)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "tradedVolume":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.TradedVolume = append(out.TradedVolume, v114)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi37(out *jwriter.Writer, in ExchangePrice) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.AvailableToBack) != 0 {
		...
		{
			out.RawByte('[')
			for v115, v116 := range in.AvailableToBack {
				if v115 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.AvailableToLay) != 0 {
		...
		{
			out.RawByte('[')
			for v117, v118 := range in.AvailableToLay {
				if v117 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.TradedVolume) != 0 {
		...
		{
			out.RawByte('[')
			for v119, v120 := range in.TradedVolume {
				if v119 > 0 {
					out.RawByte(',')
				}
...
func easyjson8e2f8dd8DecodeGithubComTarbBfapi38(in *jlexer.Lexer, out *ExBestOffersOverrides) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi38(out *jwriter.Writer, in ExBestOffersOverrides) {
	out.RawByte('{')
	first := true
	_ = first
...
func easyjson8e2f8dd8DecodeGithubComTarbBfapi39(in *jlexer.Lexer, out *EventType) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi39(out *jwriter.Writer, in EventType) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
...
func easyjson8e2f8dd8DecodeGithubComTarbBfapi40(in *jlexer.Lexer, out *Event) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi40(out *jwriter.Writer, in Event) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
...
func easyjson8e2f8dd8DecodeGithubComTarbBfapi41(in *jlexer.Lexer, out *CurrentOrderSummaryReport) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "currentOrders":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v121 CurrentOrderSummary
					(v121).UnmarshalEasyJSON(in)
					out.CurrentOrders = append(out.CurrentOrders, v121)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi41(out *jwriter.Writer, in CurrentOrderSummaryReport) {
	out.RawByte('{')
	first := true
	_ = first
	{
		...
		if in.CurrentOrders == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v122, v123 := range in.CurrentOrders {
				if v122 > 0 {
					out.RawByte(',')
				}
...
func easyjson8e2f8dd8DecodeGithubComTarbBfapi42(in *jlexer.Lexer, out *CurrentOrderSummary) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi42(out *jwriter.Writer, in CurrentOrderSummary) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		out.Raw((in.MatchedDate).MarshalJSON())
	}
	{
		const prefix string = ",\"averagePriceMatched\":"
		if first {
...
func easyjson8e2f8dd8DecodeGithubComTarbBfapi43(in *jlexer.Lexer, out *Competition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi43(out *jwriter.Writer, in Competition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
...
func easyjson8e2f8dd8DecodeGithubComTarbBfapi44(in *jlexer.Lexer, out *ClearedOrderSummaryReport) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "clearedOrders":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v124 ClearedOrderSummary
					(v124).UnmarshalEasyJSON(in)
					out.ClearedOrders = append(out.ClearedOrders, v124)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi44(out *jwriter.Writer, in ClearedOrderSummaryReport) {
	out.RawByte('{')
	first := true
	_ = first
	{
		...
		if in.ClearedOrders == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v125, v126 := range in.ClearedOrders {
				if v125 > 0 {
					out.RawByte(',')
				}
...
func easyjson8e2f8dd8DecodeGithubComTarbBfapi45(in *jlexer.Lexer, out *ClearedOrderSummary) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi45(out *jwriter.Writer, in ClearedOrderSummary) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson8e2f8dd8DecodeGithubComTarbBfapi46(in *jlexer.Lexer, out *CancelOrderRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "instructions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v127 CancelInstruction
					(v127).UnmarshalEasyJSON(in)
					out.Instructions = append(out.Instructions, v127)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi46(out *jwriter.Writer, in CancelOrderRequest) {
	out.RawByte('{')
	first := true
	_ = first
	if in.MarketID != "" {
	...
	if len(in.Instructions) != 0 {
		...
		{
			out.RawByte('[')
			for v128, v129 := range in.Instructions {
				if v128 > 0 {
					out.RawByte(',')
				}
...
func easyjson8e2f8dd8DecodeGithubComTarbBfapi47(in *jlexer.Lexer, out *CancelInstructionReport) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi47(out *jwriter.Writer, in CancelInstructionReport) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Status != "" {
...
func easyjson8e2f8dd8DecodeGithubComTarbBfapi48(in *jlexer.Lexer, out *CancelInstruction) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi48(out *jwriter.Writer, in CancelInstruction) {
	out.RawByte('{')
	first := true
	_ = first
	if in.BetID != "" {
...
func easyjson8e2f8dd8DecodeGithubComTarbBfapi49(in *jlexer.Lexer, out *CancelExecutionReport) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "instructionReports":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v130 CancelInstructionReport
					(v130).UnmarshalEasyJSON(in)
					out.InstructionReports = append(out.InstructionReports, v130)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson8e2f8dd8EncodeGithubComTarbBfapi49(out *jwriter.Writer, in CancelExecutionReport) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CustomerRef != "" {
	...
	if len(in.InstructionReports) != 0 {
		...
		{
			out.RawByte('[')
			for v131, v132 := range in.InstructionReports {
				if v131 > 0 {
					out.RawByte(',')
				}
